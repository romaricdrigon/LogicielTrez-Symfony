...
class BudgetAclProxy extends Budget implements ParentInterface, TotauxInterface, AclProxyInterface
{
    protected $proxied;
    ...
    {
        $this->proxied->categories = $children;
    }

    public function getChildren()
    {
        return $this->proxied->categories;
    }
